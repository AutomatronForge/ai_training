...
SPECIALIST = True
SPECIALIST_LEVEL = "1-3"      # the level this run trains (drives ckpt tag + final path)
...
LEARNING_RATE = 1.0e-4        # spec-1-3-cold COLD start: proven cold-climb lr (playbook 1e-4)
CLIP_RANGE = 0.2
ENT_COEF = 0.03               # spec-1-3-cold cold climb: playbook cold-start entropy (0.03); target_kl guards over-narrowing
