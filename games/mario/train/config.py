...
WARM_START_FROM = "models/specialists/mario_1-2_recover_src.zip"
...
LEARNING_RATE = 3.0e-5        # spec-1-2-rec RECOVERY: warm-start from banked 62.8% best; anti-collapse lr (v5 recipe) after the over-narrow collapse at 14.95M
CLIP_RANGE = 0.2
ENT_COEF = 0.05               # spec-1-2-rec RECOVERY: hold MORE entropy late so the policy can't over-narrow into the frozen-at-x198 collapse again
