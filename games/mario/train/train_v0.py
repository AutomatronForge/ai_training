...
class StatsCallback(BaseCallback):
    ...
    def _on_step(self) -> bool:
        ...
        for env_idx, info in enumerate(self.locals.get("infos", [])):
            ...
            # Death detection: full game decrements `life`; single-stage envs
            # (SuperMarioBros-1-2-v0) do NOT — the episode terminates without a flag.
            # Count BOTH: a life drop, OR an episode that ended without a flag grab.
        ...
        # Live viewer: push the most recent stacked frame (pixel-only; env 0 shown).
        if self._tick % 4 == 0:
            try:
